...
export default function Orange() {
  return (
    <>
      <Layout>
        <section className="grid grid-cols-12 gap-12 pt-24">
        ...
        <section className="grid grid-cols-12 gap-12">
          ...
          <div className="col-start-3 col-end-10 flex flex-col gap-8">
            <h2 className="text-3 leading-none">
              Help a coworking space reinforce their presence online
            </h2>
            <p className="text-1 text-light">
              Orange Space is a premium coworking space in Hanoi, Vietnam. Their
              mission is to offer an all-in-one office space service with clean
              aesthetics and efficiency. They needed a website that reflected
              their identity as a modern, productive workspace
            </p>
          </div>
        ...
        <section className="grid grid-cols-12 gap-12">
          <div className="col-start-1 col-end-3 flex items-start justify-start">
            <p className="rounded-full border-1 border-dark px-2 py-1 text-center text-1">
              solution
            </p>
          </div>
          <div className="col-start-3 col-end-10 flex flex-col gap-8">
            <h2 className="text-3 leading-none">More than a modern website</h2>
            <p className="text-1 text-light">
              Their request was straightforward: a beautiful website. However,
              as I explored their needs, I realized there was an opportunity to
              create something far more impactful. The project was then about
              helping Orange Space build a digital identity that aligned with
              their core values and business goals. I then crafted a website
              that captured their identity at the same time seo-optimized,
              couppled with a SEO strategy.
            </p>
          </div>
