export default function Hero() {
    return (
        <section
            id="hero"
            className="flex flex-col justify-end gap-20 text-center h-screen py-6 md:py-8 lg:py-12 2xl:py-16"
        >
                    ...
                    <h1 id="hero-title" className="text-left">
                        <svg viewBox="0 0 872 216" xmlns="http://www.w3.org/2000/svg" >
                            ...
                            <path id="letter-U"
                                ...
                                fill="black" />
                            <path id="letter-I" d="M871.169 211H849.644V4.93398H871.169V211Z" fill="black" />
                        </svg>
                    </h1>
                </div>
